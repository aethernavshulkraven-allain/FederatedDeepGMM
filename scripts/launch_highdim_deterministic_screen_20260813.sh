...
# Deterministic tuning screen (2026-08-13): 72 runs, 150 rounds, N=10 full
# participation, auxiliary_regression off. ~17.7 GPU-h, well inside the
# 48 GPU-h weekly quota. Invoke wrapped in gpurun, e.g.:
#   gpurun -g 2 bash scripts/launch_highdim_deterministic_screen_20260813.sh
#
# RETIRED 2026-08-22: pre-BatchNorm-fix legacy entry point. The server
# update this ran under corrupted BatchNorm buffers (running_var/
# num_batches_tracked) every round -- see
